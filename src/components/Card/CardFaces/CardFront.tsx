    ...
    <div className="w-full text-center">
      ...
      <div className="mt-2 md:mt-4">
        ...
        <p className="text-xs md:text-base text-gray-300">
          ...
          of stopped listening to kpop in 2020 until Love Dive released. That
          song on gromp changed my life. IVE is like 90% of what i listen to
        </p>
        <Spacer />
        <p className="text-sm md:text-lg text-gray-300 font-bold underline">
          fav kpop / biases
        ...
        <p className="text-xs md:text-base text-gray-300">
          overwatch (masters peak - sup main), league (2025 d2 peak - sup main),
          genshin (yoimiya, furina), lost ark (gs), basketball (lakers),
          skincare, fashion
        </p>
      </div>
    </div>
