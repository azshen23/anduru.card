...
const Card = () => {
  ...
  return (
    <div className="flex flex-col h-screen w-full items-center justify-center bg-gradient-to-b from-gray-900 to-black text-white ">
      <div
        className="relative w-[700px] h-[750px] cursor-pointer"
      ...
      >
        <AnimatePresence initial={false} mode="wait">
          {!isFlipped ? (
            <motion.div
              key="front"
              className="absolute w-full h-full rounded-xl bg-gray-800 p-6 shadow-lg text-center border border-gray-700 "
              initial={{ rotateY: 180 }}
              animate={{ rotateY: 0 }}
              exit={{ rotateY: 180 }}
            ...
            >
              ...
              <p className="text-md text-gray-400">23 `01</p>
              <p className="text-md text-gray-400">🇨🇳🇺🇸</p>
              <p className="text-md text-gray-400">EN/CN/KR/ESP</p>
              <div className="mt-4">
                <p className="text-gray-300">
                  lf moots ! i will fb ! (most of the time)
                </p>
                <Spacer />
                <p className="text-gray-300 font-bold underline text-lg">
                  interests
                </p>
                <p className="text-gray-300">
                ...
                <p className="text-gray-300 font-semibold">Yena</p>
                <p className="text-gray-300 font-semibold">Punch</p>
                <Spacer />
                <p className="text-gray-300">
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-2 overflow-y-auto max-h-[600px] px-4">
                {IVERanking.map((song, index) => (
                  ...
                  >
                    ...
                    <span className="text-gray-200 text-lg flex-grow text-left">
                      {song}
                    </span>
                  </div>
                ))}
      ...
      <Spacer />
      <p>(not made with carrd)</p>
      <p>(click card for my ive song ranking)</p>
    </div>
  );
};
